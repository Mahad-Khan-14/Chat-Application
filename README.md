# Chat Application
### A Chat Application using C language and Sockets
...
- if you wish to communicate with people on different pcs and laptops first ensure you all are connected to the same Wifi, then 
